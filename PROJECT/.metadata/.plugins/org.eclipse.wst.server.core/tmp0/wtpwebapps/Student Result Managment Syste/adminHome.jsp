...
<body>
<div>
	<div style="width:10%;float:left"><img src="logo.jpeg"  align="left"width="100" height="100"></div>
	<div style="width:80%;float:left"><center><h1 style="margin-top:25px";><b>INTER INSTITUTE COMPUTER CENTRE DEPARTMENT OF RTMNU</h1></center></div>
	<div style="width:10%;float:left"><img src="rtmnu.png" align="right" margin-top="1px" width="100" height="100"></div>
</div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="addNewStudent.jsp" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="email_address" class="col-md-4 col-form-label text-md-right">Semister</label>
                                    <div class="col-md-6"> 	
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insertNewResult.jsp" method="">
                                ...
                                <div class="form-group row">
                                    <label for="user_name" class="col-md-4 col-form-label text-md-right">Advance DBMS</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="phone_number" class="col-md-4 col-form-label text-md-right">Data Communication Network</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="present_address" class="col-md-4 col-form-label text-md-right">Hypertext Preprocessor (PHP)</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Software Engineering</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Practical-1</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Practical-2</label>
                                    <div class="col-md-6">
...
<section>
    ...
    <table cellpadding="0" cellspacing="0" border="0" color="black">
      <thead>
        <tr>
          ...
          <th>Advance Java</th>
          <th>Advance DBMS</th>
          <th>Data Communication Network</th>
          <th>Hypertext Preprocessor (PHP)</th>
  ...
  <div class="tbl-content">
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact RTMNU,NAGPUR.
Designed & Developed by VAIBHAO KAMBLE</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @VAIBHAO KAMBLE</h5></center> 
  <hr class="new1">
<br>
</body>
</html>