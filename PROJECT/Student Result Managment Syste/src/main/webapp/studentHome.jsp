...
<div>
	...
	<div style="width:10%;float:left"><img src="rtmnu1.jpg" align="right" margin-top="1px" width="100" height="100"></div>
</div>
...
body{
  ...
  <div class="tbl-header">
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          <th>Institution Name: Intern Institute Computer Centre,Nagpur</th>
...
<body>
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td>ECCA <br> 1T3</td>
        <td colspan="2">Data Communication Network</td>
        <td>Theory</td>
       <td>100</td>
        <td> 50 </td>
...
Designed & Developed by Vaibhao Kamble</h6></center>
  <hr class="new1">
